...
# vllm版本
uv sync
uv pip install vllm --torch-backend=auto fireredvad transformers==4.57.6
...
export ASR_VLLM_MAX_MODEL_LEN=32768
uv run python infer.py --backend=vllm
```
